...
function ft(e, t) {
    if (e) {
        ...
        r === Map  r === Set)
            return Array.from(e);
        if (r === Arguments  ^(UiI)nt(81632)(Clamped)Array$.test(r))
            return we(e, t)
    }
}
function we(e, t) {
...
var Pt = {
  ...
  , Rt = {
    paths {
        vs httpscdn.jsdelivr.netnpmmonaco-editor@0.52.2minvs
    }
};
function $t(e) {
    return function t() {
...
var Te = {
    ...
    default an unknown error accured in `@monaco-editorloader` package,
    ...
    For more please check the link httpsgithub.comsuren-atoyanmonaco-loader#config
  `
}
  , Se = $t(Tt)(Te)
  , kt = {
...
function zt() {
    var e = W(function(r) {
      ...
      , t = window.require;
    t.config(e.config),
    t([vseditoreditor.main], function(r) {
        De(r),
        e.resolve(r)
    }, function(r) {
        e.reject(r)
