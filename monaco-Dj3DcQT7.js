...
.bg-\[linear-gradient\(45deg\,transparent_25\%\,rgba\(255\,255\,255\,0\.1\)_50\%\,transparent_75\%\)\] {
    background-image: linear-gradient(45deg,transparent 25%,rgba(255,255,255,.1) 50%,transparent 75%)
}
...
.bg-\[radial-gradient\(ellipse_80\%_80\%_at_50\%_-20\%\,rgba\(255\,255\,255\,0\.1\)\,rgba\(255\,255\,255\,0\)\)\] {
    background-image: radial-gradient(ellipse 80% 80% at 50% -20%,#ffffff1a,#fff0)
}
